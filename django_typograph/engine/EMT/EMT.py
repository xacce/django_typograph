    ...
    def __init__(self):
        ...
        self.rules = {
            ...
            u"open_quote": {
                ...
                u"pattern": u"/(^|\\(|\\s|\\>|-)((\\\"|\\\\\")+)(\\S+)/iue",
                u"replacement": u"m.group(1) + QUOTE_FIRS_OPEN * ( m.group(2).count(u\"\\\"\") ) + m.group(4)"
            },
            u"close_quote": {
            ...
            u"close_quote_adv": {
                ...
                u"replacement": [
                    ...
                    u">&raquo;;\\2",
                    u">&raquo;)\\2",
                    u"QUOTE_FIRS_CLOSE * ( m.group(1).count(u\"\\\"\") )"
                ]
            },
            u"open_quote_adv": {
            ...
            u"close_quote_adv_2": {
                u"description": u"Закрывающая кавычка последний шанс",
                u"pattern": u"/(\\S)((\\\"|\\\\\")+)(\\.|\\&hellip\\;|\\;|\\:|\\?|\\!|\\,|\\s|\\)|\\<\\/|\\<|$)/uie",
                u"replacement": u"m.group(1) + QUOTE_FIRS_CLOSE * ( m.group(2).count(u\"\\\"\") ) + m.group(4)"
            },
            u"quotation": {
    ...
    def __init__(self):
        ...
        self.rules = {
            ...
            u"autospace_after_dot": {
                ...
                u"pattern": [
                    u"/(\\040|\\t|\\&nbsp\\;|^)([a-zа-яё0-9]+)(\\040|\\t|\\&nbsp\\;)?\\.([а-яёa-z]{5,})($|[^a-zа-яё])/iue",
                    u"/(\\040|\\t|\\&nbsp\\;|^)([a-zа-яё0-9]+)\\.([а-яёa-z]{1,4})($|[^a-zа-яё])/iue"
                ],
                u"replacement": [
                    u"m.group(1)+m.group(2)+u\".\" +(( u\"\"  if  m.group(5) == u\".\"  else  u\" \"))+m.group(4)+m.group(5)",
                    u"m.group(1)+m.group(2)+u\".\" +(( u\"\" if EMT_Lib.strtolower(m.group(3)) in ( self.domain_zones) else (( u\"\"  if  m.group(4) == u\".\"  else  u\" \"))))+ m.group(3)+m.group(4)"
                ]
            },
    ...
    def __init__(self):
        ...
        self.rules = {
            ...
            u"nobr_vtch_itd_itp": {
                ...
                u"cycled": True,
                u"pattern": [
                    u"/(^|\\s|\\&nbsp\\;)и( |\\&nbsp\\;)т\\.?[ ]?д(\\.|$|\\s|\\&nbsp\\;)/ue",
                    u"/(^|\\s|\\&nbsp\\;)и( |\\&nbsp\\;)т\\.?[ ]?п(\\.|$|\\s|\\&nbsp\\;)/ue",
                    u"/(^|\\s|\\&nbsp\\;)в( |\\&nbsp\\;)т\\.?[ ]?ч(\\.|$|\\s|\\&nbsp\\;)/ue"
                ],
                u"replacement": [
                    u"m.group(1)+self.tag(u\"и т. д.\", u\"span\",  {u\"class\" : u\"nowrap\"})+(( m.group(3)  if m.group(3)!=u\".\" else  u\"\" ))",
                    u"m.group(1)+self.tag(u\"и т. п.\", u\"span\",  {u\"class\" : u\"nowrap\"})+(( m.group(3)  if m.group(3)!=u\".\" else  u\"\" ))",
                    u"m.group(1)+self.tag(u\"в т. ч.\", u\"span\",  {u\"class\" : u\"nowrap\"})+(( m.group(3)  if m.group(3)!=u\".\" else  u\"\" ))"
                ]
            },
            u"nbsp_te": {
            ...
            u"nbsp_money_abbr_rev": {
                u"description": u"Привязка валюты к числу спереди",
                u"pattern": u"/(€|&euro;|\\$)\\s?(\\d)/iu",
                u"replacement": u"\\1&nbsp;\\2"
            },
            u"nbsp_org_abbr": {
...
class EMT_Tret_Nobr(EMT_Tret):
    ...
    def __init__(self):
        ...
        self.rules = {
            ...
            u"phone_builder_v2": {
                u"description": u"Дополнительный формат номеров телефонов",
                u"pattern": u"/([^\\d]|^)\\+\\s?([0-9]{1})\\s?\\(([0-9]{3,4})\\)\\s?(\\d{3})(\\d{2})(\\d{2})([^\\d]|$)/ie",
                u"replacement": u"m.group(1)+self.tag(u\"+\"+m.group(2)+u\" \"+m.group(3)+u\" \"+m.group(4)+u\"-\"+m.group(5)+u\"-\"+m.group(6), u\"span\",  {u\"class\" : u\"nowrap\"})+m.group(7)"
            },
            u"ip_address": {
            ...
            u"dots_for_surname_abbr": {
                u"disabled": True,
                u"description": u"Простановка точек к инициалам у фамилии",
                u"pattern": [
                    u"/(\\s|^|\\.|\\,|\\;|\\:|\\?|\\!|\\&nbsp\\;)([А-ЯЁ])\\.?(\\s|\\&nbsp\\;)?([А-ЯЁ])(\\s|\\&nbsp\\;)([А-ЯЁ][а-яё]+)(\\s|$|\\.|\\,|\\;|\\:|\\?|\\!|\\&nbsp\\;)/ue",
                    u"/(\\s|^|\\.|\\,|\\;|\\:|\\?|\\!|\\&nbsp\\;)([А-ЯЁ][а-яё]+)(\\s|\\&nbsp\\;)([А-ЯЁ])\\.?(\\s|\\&nbsp\\;)?([А-ЯЁ])\\.?(\\s|$|\\.|\\,|\\;|\\:|\\?|\\!|\\&nbsp\\;)/ue"
                ],
                u"replacement": [
                    u"m.group(1)+self.tag(m.group(2)+u\". \"+m.group(4)+u\". \"+m.group(6), u\"span\",  {u\"class\" : u\"nowrap\"})+m.group(7)",
            ...
            u"spaces_nobr_in_surname_abbr": {
                ...
                u"replacement": [
                    u"m.group(1)+self.tag(m.group(2)+u\". \"+m.group(4)+u\". \"+m.group(6), u\"span\",  {u\"class\" : u\"nowrap\"})+m.group(7)",
                    u"m.group(1)+self.tag(m.group(2)+u\" \"+m.group(4)+u\". \"+m.group(6)+u\".\", u\"span\",  {u\"class\" : u\"nowrap\"})+m.group(7)",
                    u"m.group(1)+self.tag(m.group(2)+(( u\" \"  if (m.group(3)) else  u\"\" ))+m.group(4)+(( u\" \"  if (m.group(5)) else  u\"\" ))+m.group(6), u\"span\",  {u\"class\" : u\"nowrap\"})+m.group(7)",
                    u"m.group(1)+self.tag(m.group(2)+u\" \"+m.group(4)+(( u\" \"  if (m.group(5)) else  u\"\" ))+m.group(6), u\"span\",  {u\"class\" : u\"nowrap\"})+m.group(7)"
                ]
            },
...
class EMT_Tret_OptAlign(EMT_Tret):
    ...
    def __init__(self):
        ...
        self.rules = {
            ...
            u"oa_obracket_coma": {
                u"description": u"Оптическое выравнивание для пунктуации (скобка)",
                u"pattern": [
                    u"/(\\040|\\&nbsp\\;|\\t)\\(/ei",
                    u"/(\\n|\\r|^)\\(/ei"
                ],
...
class EMT_Tret_Etc(EMT_Tret):
    ...
    def __init__(self):
        ...
        self.rules = {
            ...
            u"split_number_to_triads": {
                u"description": u"Разбиение числа на триады",
                u"pattern": u"/([^a-zA-Z0-9<\\)]|^)([0-9]{5,})([^a-zA-Z>\\(]|$)/eu",
                u"replacement": u"m.group(1)+EMT_Lib.str_replace(u\" \",u\"&thinsp;\",EMT_Lib.split_number(m.group(2)))+m.group(3) "
            },
            ...
            u"nobr_to_nbsp": {
                u"description": u"Преобразование nobr в nbsp",
                u"disabled": True,
                u"function": u"nobr_to_nbsp"
            }
        }
        self.rule_order = [
            u"acute_accent",
